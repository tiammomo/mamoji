...
class CategoryServiceIntegrationTest extends MySqlIntegrationTestBase {
    ...
    void listCategoriesByType_ShouldFilterCorrectly() {
        // Given
        FinCategory expense1 = FinCategory.builder()
                .userId(testUserId)
                .name("Food")
                .type("expense")
                .status(1)
        ...
        FinCategory expense2 = FinCategory.builder()
                .userId(testUserId)
                .name("Transportation")
                .type("expense")
                .status(1)
        ...
        FinCategory income = FinCategory.builder()
                .userId(testUserId)
                .name("Salary")
                .type("income")
                .status(1)
        ...
        // When
        List<CategoryVO> expenseCategories = categoryService.listCategoriesByType(testUserId, "expense");
        List<CategoryVO> incomeCategories = categoryService.listCategoriesByType(testUserId, "income");
    ...
    void deleteCategory_ShouldSetStatusToZero() {
        ...
        Long activeCount = categoryMapper.selectCount(
