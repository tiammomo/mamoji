...
/**
 * Base integration test class with MySQL database Uses local MySQL Docker container for real
 * database testing Uses @Transactional for automatic rollback after each test
 */
